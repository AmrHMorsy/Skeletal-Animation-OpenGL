...
FBXModel::FBXModel( std::string modelfilepath, std::vector<std::string> texturesfilepaths, glm::mat4 v, glm::mat4 proj, glm::vec3 c, std::string vsfilepath, std::string fsfilepath): view(v), projection(proj), camera(c), model_filepath(modelfilepath), file_paths(texturesfilepaths), vs_filepath( vsfilepath), fs_filepath( fsfilepath )
{
...
void FBXModel::initialize_variables()
{
    ...
    light_color = glm::vec3( 50.0f, 50.0f, 50.0f ) ;
